...
{{-- <div class="hero-wrap hero-bread" style="background-image: url('Frontend/images/bg_6.jpg');"> --}}
	<div class="hero-wrap hero-bread" style="background-image: {{ url('public/Frontend/images/bg_6.jpg') }};">
      <div class="container">	
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.html">Cửa hàng</a></span><span>chính</span></p>
          ...
          <div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
            <div class="product d-flex flex-column">
              <a href="#" class="img-prod">
				{{-- <img class="img-fluid" src="public/Frontend/images/.{{ $du->image }}" alt="Colorlib Template"> --}}
				<img src="{{ url('public/Frontend/images/'.$du->image) }}" width='270' height='200'>
